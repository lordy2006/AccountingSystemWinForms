namespace AccountingSystemWinForms
{
    partial class NoteControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            label3.TabIndex = 14;
            label3.Text = "Comprehensive tools to manage your finances efficiently";
            // 
            // label2
            // 
            ...
            label2.TabIndex = 13;
            label2.Text = "EVERYTHING YOU NEED";
            ...
            label1.TabIndex = 36;
            label1.Text = "Easily record and manage financial transactions with intuitive input fields for dates, descriptions, and amounts.";
            // 
            // lblNewTransactions
            // 
            ...
            btnProcceed.OverrideDefault.Border.Color1 = Color.White;
            btnProcceed.OverrideDefault.Border.Color2 = Color.White;
            btnProcceed.OverrideFocus.Back.Color1 = Color.FromArgb(0, 124, 255);
            btnProcceed.OverrideFocus.Back.Color2 = Color.FromArgb(0, 124, 255);
            ...
            btnProcceed.StateNormal.Back.Color2 = Color.FromArgb(7, 67, 130);
            btnProcceed.StateNormal.Border.Color1 = Color.White;
            btnProcceed.StateNormal.Border.Color2 = Color.White;
            btnProcceed.StatePressed.Back.Color1 = Color.FromArgb(0, 124, 255);
            btnProcceed.StatePressed.Back.Color2 = Color.FromArgb(0, 124, 255);
            btnProcceed.StatePressed.Border.Color1 = Color.White;
            btnProcceed.StatePressed.Border.Color2 = Color.White;
            btnProcceed.StateTracking.Back.Color1 = Color.FromArgb(0, 124, 255);
            btnProcceed.StateTracking.Back.Color2 = Color.FromArgb(0, 124, 255);
            btnProcceed.StateTracking.Border.Color1 = Color.White;
            ...
            Controls.Add(label1);
            Controls.Add(lblNewTransactions);
        ...
        private Label lblNewTransactions;
